                                ...
                                <form action="index.php">
                                  <ul>
                                      ...
                                      <p class="old">
                                        ...
                                        <input type="text" name="first_name" placeholder="Tabitha" />
                                      </p>
                                      <p class="new">
                                        <label for="last_name">last name:</label>
                                        <input type="text" name="last_name" placeholder="Kimani" />      
                                      </p>
                                    
                                      <p>
                                        <label for="email">email:</label>
                                        <input type="email" name="email" placeholder="tabkimani@gmail.com" />
                                      </p>
