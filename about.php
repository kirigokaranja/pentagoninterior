                ...
                <div class="col-md-12">
                    ...
                    <nav>
                        <ul id="mainmenu">
                            ...
                            <li><a href="about.php" class="active">About Us</a>
                                <ul>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-6 col-xs-12 content">
                            ...
                            <a href="history.php" class="btn btn-outline btn-outline outline-dark">Our History</a>
                        </div>
                    </div><!-- /.row-->
                </div><!-- /.container -->
            </section>
            ...
            <div class="teamrow">
                <div class="teamcolumn">
                    ...
                    <div class="teamcontainer">
                        <h3>Johny Smith</h3>
                        <p class="jobtitle">Principal Designer</p>
                        <div class="small-border"></div>
                        <p>Oversees all the major decisions and helps the team members be united and work together..</p>
                    </div>
                </div>
                <div class="teamcolumn">
                    <div class="teamcard">
                    ...
                    <div class="teamcontainer">
                        <h3>Sarah Michele</h3>
                        <p class="jobtitle">Business Manager</p>
                        <div class="small-border"></div>
                ...
                <div class="teamcolumn">
                    ...
                    <div class="teamcontainer">
                        ...
                        <p class="jobtitle">Junior Designer</p>
                        <div class="small-border"></div>
                        <p>CAD Drafting + Design
                            Select Materials + Furnishings
                            Assist Principal Designe.</p>
                    </div>
                </div>
                <div class="teamcolumn">
                    <div class="teamcard">
                    ...
                    <div class="teamcontainer">
                        ...
                        <div class="small-border"></div>
                        <p>After a hugely successful year in which she oversaw the installation of an
                            unprecedented number of interior design schemes.</p>
                    </div>
                </div>
            </div>
        </section>
