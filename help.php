...
<div id="wrapper">
    ...
    <div id="content" class="no-bottom no-top">
            <div class="col-md-6 col-md-offset-3 text-center wow fadeInUp" style="margin-top: 9%; visibility: visible">
                <h1>Navigating through the Website</h1>
       ...
       <section id="aboutcontent">
           ...
           <section id="content-3-10" class="content-block data-section nopad content-3-10" style="margin-top: 10%">
               <br>
               <div class="image-container col-sm-6 col-xs-12 pull-left" style="height: 86%;margin-top: 5%;">
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>This page gives an overview of what Pentagon Interior is and some of the services offered. To navigate to the Home page click the link below </p>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>This page gives a detailed description of our company, including its History and all Services we provide. To have a look at our History and Services, click on the links below </p>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>This page displays the companies/clients we have worked with and the services rendered to them. To navigate to the Home page click the link below or the one provided at the menu above</p>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>This page displays the products and services we offer. To see some of the above, click the link provided below or the one on the main menu</p>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>This module outlines some of the core values, vision and mission that Pentagon Interiors operates on. It also displays some of the products provided by our company. </p>
               ...
               <div class="container-fluid">
                   <div class="row">
                       <div class="text-center col-md-6-12 content">
                           ...
                           <div class="editContent">
                               <p>To communicate with our company, one can directly contact us through the Phone Number provided on the Quick Links provided below or, by filling out the form provided in the Contact module, whose link is provided below</p>
