<head>
    <meta charset="utf-8">
    <title>Pentagon Interior | Gallery</title>
    ...
    <div id="content" class="no-bottom no-top">
        ...
        <section id="section-portfolio" class="no-bottom" aria-label="section-portfolio">
            ...
            <div id="gallery" class="gallery full-gallery de-gallery pf_full_width wow fadeInUp" data-wow-delay=".3s">
                ...
                global $conn;
                $sql="SELECT * FROM `maingallery`";
                $records=mysqli_query($conn,$sql);
                while($images=mysqli_fetch_assoc($records)){
                    $ImageName=$images['FileName'];
                    $Descripton=$images['Description'];
                    ...
                    echo " <div class='item'>
                                ...
                                <span class='overlay'>
                                    <span class='pf_text'>
                                        <span class='project-name'>".$Descripton."</span>
                                    </span>
                                </span>
                        </a>
        ...
        <section id="view-all-projects" class="call-to-action bg-color text-center" data-speed="5" data-type="background" aria-label="view-all-projects">
            <a href="clientele.php" class="btn btn-line-black btn-big">View Our Clientele</a>
        </section>
